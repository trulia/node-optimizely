...
function jquery(html)
{
  ...
  // don't do anything on .detach(), since it's usually used for temporary removal from the dom
  // just allow chaining
  cheerio.prototype.detach = function(){ return this; };

  // allow insertBefore and insertAfter methods
